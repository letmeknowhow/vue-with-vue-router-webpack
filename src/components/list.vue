...
<template>
  <header class="header mui-bar mui-bar-nav">
    ...
    <button v-link="{ path: '/asi' }" class="mui-btn mui-btn-link mui-btn-nav mui-pull-right"><span
  ...
  <div class="mui-content">
    <div class="eating-box">
      <ul>
        ...
        <li class="eating-card" v-for="item in optionsValue" :class="item.img" @click="openDelIt(item.id)">
